...
//    }
//
//    // Copied from org.sakaiproject.mbm.servlet.SakaiToolServlet, and merged in original implemetation (from below)
//    @Override
...
//        }
//
//        // See if we have a resource request - ie. a path with an extension, and on that is not the requestExt
...
//        {
//            res.sendRedirect( contextPath + startPage );
//        }
//        else
//        {
//            RequestDispatcher dispatcher = req.getRequestDispatcher( target );
//            dispatcher.forward( wrappedReq, res );
//        }
//    }
